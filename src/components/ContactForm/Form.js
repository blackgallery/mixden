        ...
        <form method="post" id="contactForm">
          <div className="row">
            <div className="col-md-6 col-sm-12">
              ...
              <div className="input-group">
                <input type="text" id="tel" value={this.state.subject} onChange={this.handleChangeSubject}
            ...
            <div className="form-group col-md-6 col-sm-12">
              <div className="input-group input_group_full_width">
                          <textarea name="comments" id="message" value={this.state.message}
                                    onChange={this.handleChangeMessage} rows="6" className="form-control"
                                    placeholder="Message"/>
                <span id="err">{this.state.message_err}</span>
              </div>
            </div>
            <div className="col-sm-12">
              <button type="button" name="send" onClick={this.handleSubmit1}
                      className="submit-button btn btn-chos" value="Submit">Submit
              </button>
              <div id="simple-msg"/>
            </div>
