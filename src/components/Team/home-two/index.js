      ...
      <div className="row">
        <div className="col-12">
          ...
          <Carousel autoPlay showArrows>
            {
              teamData.slice(0, 4).map((team, id) => (
                <div className="team_content" key={id}>
                  <div className="team_content_wrap">
                    ...
                    <div className="team_social_link">
                      <ul>
                        <li>
                          <a href={` ${team.twitterUrl} `}> <i className="fa fa-twitter"/></a>
                        </li>
                        <li><a href={`${team.instagramUrl} `}> <i className="fa fa-instagram"/></a>
                        </li>
                        <li><a href={`${team.linkedinUrl} `}> <i className="fa fa-pinterest"/></a>
                        </li>
                        <li><a href={`${team.facebookUrl} `}> <i className="fa fa-dribbble"/></a>
                        </li>
                      </ul>
                    </div>
                    <p className="team_text">{team.text}</p>
                  </div>
