        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-xs-12">
            <div className="skill-text">
              <h2>How we work</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed dapibus enim sit amet pellentesque
                imperdiet nibh tortor fringilla tortor eu sodales leo augue eget justo. Phasellus id lectus id metus
                ornare sempereget rem ipsum dolor
                sit amet consectetur adipiscing elit. Sed dapibus enim sit amet pellentesque imperdiet nibh tortor
                fringilla tortor </p>
            </div>
